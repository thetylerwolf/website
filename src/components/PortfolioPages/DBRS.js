            ...
            <Grid>
              ...
              <Row>
                <Col xs={ 12 } sm={ 12 } md={ 8 } xl={ 8 } lg={ 8 }>
                  ...
                  <p>
                    In addition to introducing new data, we added functionality to make it easier for users to
                    compare investments across countries both visually (on the map) and in a spreadsheet format.
                  </p>
                </Col>
              </Row>
              ...
              <Row>
                <Col className="image-container" xs={ 12 } sm={ 12 } md={ 8 } xl={ 8 } lg={ 8 }>
                  <img alt="US investment research map" src="/portfolio/dbrs/dbrs.jpg" />
                </Col>
              </Row>
              ...
              <Row>
                <Col className="image-container" xs={ 12 } sm={ 12 } md={ 8 } xl={ 8 } lg={ 8 }>
                  <img alt="european investment research map" src="/portfolio/dbrs/europe.jpg" />
                </Col>
              </Row>
